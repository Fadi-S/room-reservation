...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'app.allow_auto_approve_for_one_time_reservations' => 'boolean',
            'app.rooms_that_must_be_approved_manually' => 'array',
            'app.locations_that_must_be_approved_manually' => 'array',
            ...
            'filesystems.links./Users/fadi/Documents/Projects/reservation/public/storage' => 'string',
            ...
            'laravel-passwordless-login.user_model' => 'string',
            'laravel-passwordless-login.user_guard' => 'string',
            'laravel-passwordless-login.remember_login' => 'boolean',
            'laravel-passwordless-login.login_route' => 'string',
            'laravel-passwordless-login.login_route_name' => 'string',
            'laravel-passwordless-login.login_route_expires' => 'string',
            'laravel-passwordless-login.redirect_on_success' => 'string',
            'laravel-passwordless-login.login_use_once' => 'boolean',
            'laravel-passwordless-login.invalid_signature_message' => 'string',
            'laravel-passwordless-login.middleware' => 'array',
...
'admin','viewTelescope','viewAny','view','create',
'update','delete','restore','pause','forceDelete',);
...
'app.allow_auto_approve_for_one_time_reservations','app.rooms_that_must_be_approved_manually','app.locations_that_must_be_approved_manually','auth.defaults.guard','auth.defaults.passwords',
...
'filesystems.links./Users/fadi/Documents/Projects/reservation/public/storage','fortify.guard','fortify.middleware','fortify.auth_middleware','fortify.passwords',
'fortify.username','fortify.email','fortify.views','fortify.home','fortify.prefix',
'fortify.domain','fortify.lowercase_usernames','fortify.limiters.two-factor','fortify.paths.login','fortify.paths.logout',
...
'hashing.argon.time','hashing.rehash_on_login','laravel-passwordless-login.user_model','laravel-passwordless-login.user_guard','laravel-passwordless-login.remember_login',
'laravel-passwordless-login.login_route','laravel-passwordless-login.login_route_name','laravel-passwordless-login.login_route_expires','laravel-passwordless-login.redirect_on_success','laravel-passwordless-login.login_use_once',
'laravel-passwordless-login.invalid_signature_message','laravel-passwordless-login.middleware','logging.default','logging.deprecations.channel','logging.deprecations.trace',
...
'telescope.watchers.Laravel\\Telescope\\Watchers\\ExceptionWatcher','telescope.watchers.Laravel\\Telescope\\Watchers\\GateWatcher.enabled','telescope.watchers.Laravel\\Telescope\\Watchers\\GateWatcher.ignore_abilities','telescope.watchers.Laravel\\Telescope\\Watchers\\GateWatcher.ignore_packages','telescope.watchers.Laravel\\Telescope\\Watchers\\JobWatcher',
...
'telescope.watchers.Laravel\\Telescope\\Watchers\\ViewWatcher','view.paths','view.compiled','concurrency.default','debugbar.enabled',
...
'inertia.ssr.url','inertia.testing.ensure_pages_exist','inertia.testing.page_paths','inertia.testing.page_extensions','excel.exports.chunk_size',
...
'debugbar.cache.delete','debugbar.queries.explain','login.store','logout','user-password.update',
'password.confirmation','password.confirm.store','sanctum.csrf-cookie','telescope','ignition.healthCheck','ignition.executeSolution','ignition.updateConfig','login.temp','login',
'table','table.print.location','table.print','tv','home',
'reservations.pause','reservation.create','reservation.store','reservation.approve',
'reservation.absence','reservation.absence.delete','reservation.delete','reservation.stop','reservation.not-approved',
'reservations.edit','reservations.personal','reservation.update','users.index','users.create',
'users.store','users.show','users.edit','users.update','users.destroy',
'users.link',);
        registerArgumentsSet('views', 
'app','auth.sendLink','emails.reservation-approved','emails.reservation-made','tv',
...
'validation.url','validation.ulid','validation.uuid','validation.custom.attribute-name.rule-name','ui.email_sent',
'ui.reserved','ui.waiting_for_approval','ui.approved','ui.reservation_deleted','ui.reservation_edited',
'ui.reservation_stopped','ui.user_created','ui.user_edited','ui.reservation_paused','ui.reservation_absence',
'ui.reservation_absence_cancel','validation.day_of_week','validation.attributes.room','validation.attributes.name','validation.attributes.email',
'validation.attributes.day_of_week','validation.attributes.dayOfWeek','validation.attributes.start','validation.attributes.end','validation.attributes.date',
'validation.conflict',);
        registerArgumentsSet('env', 
'APP_NAME','APP_ENV','APP_KEY','APP_DEBUG','APP_URL',
'DOMAIN','LOG_CHANNEL','LOG_DEPRECATIONS_CHANNEL','LOG_LEVEL','DB_CONNECTION',
'DB_HOST','DB_PORT','DB_DATABASE','DB_USERNAME','DB_PASSWORD',
'BROADCAST_DRIVER','CACHE_DRIVER','REDIS_CLIENT','FILESYSTEM_DISK','QUEUE_CONNECTION',
...
'VITE_PUSHER_APP_CLUSTER','VITE_DOMAIN',);
